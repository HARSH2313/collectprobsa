        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 relative h-64 md:h-auto mb-8 md:mb-0">
              <Image
                src="/images/expertise/overview.jpg"
            ...
            <div className="md:w-1/2 md:pl-12">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                We understand that every financial situation is unique. That&rsquo;s why we offer a range of services designed to meet your specific needs, ensuring that you receive the most effective and sustainable outcomes.
              </p>
            </div>
          </div>
        </div>
